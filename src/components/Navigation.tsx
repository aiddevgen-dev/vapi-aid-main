    ...
    <header className="sticky top-0 z-50 bg-background border-b shadow-sm">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          >
            <img src="/complete-credit-logo.png" alt="Complete Credit Solutions" className="h-10 w-10 rounded-lg" />
            <span className="text-xl font-bold text-primary">Complete Credit Solutions</span>
          </button>
